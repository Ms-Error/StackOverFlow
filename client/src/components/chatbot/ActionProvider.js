...
const ActionProvider = ({ createChatBotMessage, setState, children }) => {
  ...
  const handleBye = () => {
    const botMessage = createChatBotMessage(
      "Thank you for using me. Have a great day!"
    );
  ...
  const handleIntro = () => {
    const botMessage = createChatBotMessage(
      "I am Stack Overflow bot. I am here to answer your questions"
    );
  ...
  const handleObjectOriented = () => {
    const botMessage = createChatBotMessage(
      "Java supports the concepts of OOPS - Inheritance, Data abstraction, polymorphism, and data encapsulation. but Java is not fully object-oriented because it supports primitive data types like it,byte,long etc.,which are not objects.."
    );
  ...
  const handleOopConcept = () => {
    const botMessage = createChatBotMessage(
      "Object, Class, Polymorphism, Inheritance, Encapsulation, Abstraction"
    );
  ...
  const handleLanguages = () => {
    const botMessage = createChatBotMessage(
      "Javascript, Python, Go, Java, Kotlin, C, and C++"
    );
  ...
  const handleCPP = () => {
    const botMessage = createChatBotMessage(
      "C++ (or “C-plus-plus”) is a general-purpose programming and coding language. C++ is used in developing browsers, operating systems, and applications, as well as in-game programming, software engineering, data structures, etc.5"
    );
