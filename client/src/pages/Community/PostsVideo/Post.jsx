  ...
  return (
    <div className='post'>
        <div className="top-post">
            ...
            <Avatar backgroundColor='#009dff' px="13px" py="5px" borderRadius="50%" color='white'><Link to={`/User/${post.userId}`} style={{color:"white", textDecoration:'none', display:"flex", justifyContent:"center"}}>{post.postedBy.charAt(0).toUpperCase()}</Link></Avatar>
            </p>
